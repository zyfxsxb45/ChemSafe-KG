...
覆盖 1,174 起去重后事故的因果链条，从应急管理部（mem.gov.cn）全量月度汇编和微信公众号事故分析文章中，通过 LLM 驱动的 Prompt Chain 策略自动抽取构建。配套 Neo4j 图数据库 6,976 节点、23,111 条因果关系边。
...
@dataset{chemsafe-kg-v0.7.1-2026,
  title={ChemSafe-KG v0.7.1: A Large-Scale Knowledge Graph Dataset for Chemical Accident Causal Analysis},
  author={Zhai, Yu, Zhao},
  year={2026},
